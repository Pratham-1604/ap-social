...
export default function LeftSideComponent() {
  return (
    <>
      <div className="container bg-purple-800 p-[25px] w-[25rem] h-[35rem] rounded-tr rounded-br flex-0 flex-row my-[7rem]">
        <div className="container px-2 py-2 text-white">
          <ul>
            <li>
              <h1 className="font-bold text-[48px]">AP Social.</h1>
            </li>
            <li>
